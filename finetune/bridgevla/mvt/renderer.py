...
#
# NOTE: the BoxRenderer in this file is **unused** in the current code path.
# `from point_renderer.rvt_renderer import RVTBoxRenderer as BoxRenderer` in mvt.py
# overrides BoxRenderer at runtime. For the renderer actually in use, see
# finetune/bridgevla/libs/point-renderer/point_renderer/rvt_renderer.py
# (note that its elev_azim/cam_names differ from the ones here: this file hard-codes 5 views
#  top/front/back/left/right, whereas RVTBoxRenderer picks 3 or 5 views based on rend_three_views and friends).
