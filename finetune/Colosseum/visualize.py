"""Training-time visualization for Colosseum (ported from RLBench/visualize.py).
...
from utils.peract_utils_colosseum import CAMERAS as COLOSSEUM_CAMERAS
...
def visualize_samples(
    ...
    cameras: Sequence[str] = COLOSSEUM_CAMERAS,
