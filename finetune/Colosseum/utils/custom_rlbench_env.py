...
from utils.multitask_rlbench_env import MultiTaskRLBenchEnv

# NOTE: the upstream rvt_colosseum CustomRLBenchEnv (single-task env) was
# removed here: it referenced an undefined task_class_variation_idx in its
# __init__ (NameError on instantiation) and nothing imports it — eval.py only
# uses CustomMultiTaskRLBenchEnv2.
