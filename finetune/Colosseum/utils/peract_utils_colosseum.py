...
IMAGE_SIZE = 128
# Colosseum data root; train.sh/eval.sh export COLOSSEUM_DATA_FOLDER from
# ${BRIDGEVLA_DATA_ROOT}/Colosseum. The fallback derives the same path from
...
DATA_FOLDER = os.environ.get(
    ...
    os.path.join(_BRIDGEVLA_ROOT, "data", "bridgevla_data", "Colosseum"),
)
